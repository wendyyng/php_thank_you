...
<div class="card container m-4 p-4 w-50 flex-column d-flex justify-content-center align-items-center">
    ...
    <ul>
        ...
        <li>Educators and paraprofessionals</li>
    </ul>
    <p class="text-center">
        Our COVID-19 frontline heroes are still suffering from emotional trauma and physical fatigue.
        We are expressing our gratitude for all that our heroes have sacrificed for us.
        Join us in sending them meaningful messages of support.
    </p>
</div>
